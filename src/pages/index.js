    ...
    <Layout>
            ...
            <div className="container">
                <div className="profile-teaser media flex-column flex-md-row">
                    ...
                    <div className="media-body text-center text-md-left">
                        ...
                        <div className="bio mb-3">I'm a self-learned web developer specialising in React.<br/> Check out my <Link className="link-on-bg" to="/projects/">portfolio</Link> and <Link className="link-on-bg" to="/resume/">resume</Link>.</div>{/*//bio*/}
                        <Link className="theme-btn-on-bg btn font-weight-bold theme-btn-cta" to="/contact/">Let's talk</Link>
                    </div>{/*//media-body*/}
                </div>{/*//profile-teaser*/}
            </div>{/*//container*/}
        </div>{/*//header-intro*/}
        <section className="skills-section section py-5">
            <div className="container">
                ...
                <div className="section-intro mx-auto text-center mb-5 text-secondary">Below is a quick overview of my main technical skill sets and tools I use.</div>
