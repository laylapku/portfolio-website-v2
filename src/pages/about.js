                ...
                <div className="profile-teaser media flex-column flex-md-row">
                      <img alt="" className="profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="/images/profile.jpg" />
                        <div className="media-body text-center text-md-left">
                          ...
                          <div className="bio mb-3">I'm a full-stack developer specialised in frontend and backend web app development. Want to know how I may help your project? Check out my project <a className="link-on-bg" href="/projects">case studies</a> and <a className="link-on-bg" href="/resume">resume</a>.</div>{/*//bio*/}
                          <a className="theme-btn-on-bg btn font-weight-bold theme-btn-cta" href="/contact">Hire Me</a>
                          </div>{/*//media-body*/}
                    </div>{/*//profile-teaser*/}
          </div>{/*//container*/}
        </div>{/*//header-intro*/}      
